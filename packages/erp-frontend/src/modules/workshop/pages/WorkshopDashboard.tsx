...
import { Plus, Wrench, FileText, Pencil, Trash2, LayoutDashboard } from 'lucide-react';
...
export const WorkshopDashboard = () => {
  const { user } = useAuth();
  const { orders, createOrder, updateOrder, deleteOrder, updateStatus } = useWorkshop();
