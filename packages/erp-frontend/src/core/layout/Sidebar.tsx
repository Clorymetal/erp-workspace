      ...
      <div className="p-6 flex items-center justify-between">
        {!collapsed && (
          <motion.div 
            ...
            animate={{ opacity: 1 }} 
            exit={{ opacity: 0 }}
            className="font-bold text-xl bg-gradient-to-r from-primary-500 to-purple-500 bg-clip-text text-transparent truncate"
          >
            Clorymetal
          </motion.div>
        )}
        ...
        <div className={`flex items-center gap-3 ${collapsed ? 'justify-center' : ''}`}>
          ...
          {!collapsed && (
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-gray-500 truncate">admin@clorymetal.com</p>
            </div>
          )}
        </div>
      </div>
